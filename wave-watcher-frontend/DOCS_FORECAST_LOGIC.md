...
- **`facingDir`**: The compass degree the beach "looks" at.
  - _Example:_ If a beach faces West ($270^\circ$), an offshore wind comes from the East ($90^\circ$).
...
- _Result:_ A $2.0m$ swell at $14s$ translates to a much larger breaking wave than a $2.0m$ swell at $8s$.
...
_The multiplier 14 is tuned to match the kJ values typical of North Indian Ocean/Sumatran swell power._
